...
export default function ComoFuncionaSection() {
  return (
    <section id="como-funciona" className="bg-white py-[70px]">
      <div className="max-w-[1060px] mx-auto px-6">

        <div className="flex flex-col items-center text-center gap-[10px] mb-[60px]">
          <h2 className="text-[3rem] font-bold text-[#0F172A] leading-tight max-sm:text-[2.2rem]">Como a TechLaço Funciona</h2>
          <p className="text-[#64748B] text-[1.1rem] max-w-[480px] leading-[1.65]">
        ...
        <div className="grid grid-cols-3 gap-7 max-w-[900px] mx-auto max-md:grid-cols-1">
